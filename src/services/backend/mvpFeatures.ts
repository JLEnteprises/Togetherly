...
export async function updatePreferences(input: Partial<{
  reducedMotion: boolean; haptics: boolean; highContrast: boolean; notificationEvents: boolean; notificationTasks: boolean; notificationCountdowns: boolean; notificationPartnerActivity: boolean; notificationDailyQuestion: boolean; notificationPartnerMood: boolean; notificationGoalMilestones: boolean; notificationMemories: boolean; notificationVisitApproaching: boolean;
