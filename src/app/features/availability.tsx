...
export default function AvailabilityScreen() {
  ...
  return <AppScreen>
    ...
    <AppText variant="section" style={{ marginBottom: theme.spacing.md }}>{profile?.display_name ?? 'My'} schedule</AppText><View style={{ gap: theme.spacing.md, marginBottom: theme.spacing.xxl }}>{mine.length ? mine.map((item) => scheduleCard(item, true)) : <EmptyState icon="availability" title="No schedule yet" body="Add at least one Free window. Work, Sleep and Busy windows will subtract from it." actionLabel="Add a window" onAction={() => setOpen(true)} />}</View>
