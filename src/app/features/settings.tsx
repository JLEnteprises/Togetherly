...
const preferences = [
  { icon: '⌂', title: 'Home layout', subtitle: 'Show, hide or reorder the four Home sections', href: '/features/home-layout' },
  { icon: '◐', title: 'Appearance', subtitle: 'Identity colours and backdrop theme', href: '/features/themes' },
  { icon: '◌', title: 'Notifications', subtitle: 'Choose what deserves your attention', href: '/features/notifications' },
] as const;
