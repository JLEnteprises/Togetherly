  ...
  return (
    <AppScreen>
      ...
      <View style={{ gap: theme.spacing.md }}>
        {searched && !busy && results.length === 0 ? <EmptyState icon="⌕" title="Nothing matched" body="Try a different word or phrase." /> : null}
        {results.map((result) => (
